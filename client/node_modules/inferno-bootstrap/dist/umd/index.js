(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('inferno-shared'), require('classnames'), require('inferno-create-element'), require('lodash.isobject'), require('inferno'), require('inferno-popper'), require('lodash.tonumber'), require('inferno-animation')) :
  typeof define === 'function' && define.amd ? define(['exports', 'inferno-shared', 'classnames', 'inferno-create-element', 'lodash.isobject', 'inferno', 'inferno-popper', 'lodash.tonumber', 'inferno-animation'], factory) :
  (factory((global.InfernoBootstrap = {}),global.infernoShared,global.classNames,global.infernoCreateElement,global.isobject,global.Inferno,global.infernoPopper,global.toNumber,global.infernoAnimation));
}(this, (function (exports,infernoShared,classNames,infernoCreateElement,isobject,inferno,infernoPopper,toNumber,infernoAnimation) { 'use strict';
